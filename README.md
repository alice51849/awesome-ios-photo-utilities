...
A curated list of useful iPhone and iPad apps for taking, editing, scanning, improving, organizing, and preparing photos. This is a practical, non-ranked list: established apps and smaller indie tools are included when they solve a clear photo workflow.
...
- [Adobe Lightroom](https://apps.apple.com/app/id878783582) - A mature photo editor with RAW support, presets, masking, and cloud sync.
...
- [Halide Mark II](https://apps.apple.com/app/id885697368) - Pro camera app with manual controls, RAW capture, and computational photography tools.
- [ProCamera](https://apps.apple.com/app/id694647259) - Full-featured camera app for manual exposure, video, and low-light shooting.
- [Camera+](https://apps.apple.com/app/id1313580627) - Long-running camera app with manual shooting and editing features.
- [Lightroom Camera](https://apps.apple.com/app/id878783582) - Built into Lightroom for DNG capture and immediate editing.

## Scanning

- [Adobe Scan](https://apps.apple.com/app/id1199564834) - Reliable document scanning with OCR and Adobe cloud integration.
...
- [Google Photos](https://apps.apple.com/app/id962194608) - Cross-platform backup, search, sharing, and album management.
